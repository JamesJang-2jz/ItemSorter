...
public class SortByPriceTest {
    ...
    public void testSortPrice1() {
        ...
        // when
        Item[] actual = itemSorter.sort(comparator); // items sorted in asc from 1.0, 2.0, 3.5

        // then
        Assert.assertArrayEquals(expected, actual);
    }
    @Test
    public void testSortPrice2() {
        // given
